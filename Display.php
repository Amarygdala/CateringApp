...
<!-- MAKE SORT BY DATE GET DATE COLUMN MAKE SURE DATE IN DATABASE IS DATE TYPE-->
<?php
	include("..\CateringApp\connection.php");
	$showNum = $_POST['shrtNum'];
