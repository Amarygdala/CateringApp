...
//Gets the information from the form, then runs the query to insert into database.
	...
	$dbinsert = "INSERT INTO cateringdata (Date,StartTime,EndTime,Meal,Room,DeliveryTime,MorningBreak,AfternoonBreak,Floor,Attendees,Purpose,Restrictions,HotCold,Drinks,Vendor,Food,CostCenter,Organizer) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
